...
struct ImGui_ImplOpenGL3_Data
{
	...
	GLuint          FontTexture;
	// Image data
	std::vector<GLuint>  mesaDecalDataList;
	GLuint          ShaderHandle;
...
namespace Karma
{
	...
	bool ImGuiOpenGLHandler::ImGui_ImplOpenGL3_CreateFontsTexture()
	{
		...
		for(GLuint& decal : bd->mesaDecalDataList)
		{
	...
	bool ImGuiOpenGLHandler::CheckShader(GLuint handle, const char* desc)
	{
		ImGui_ImplOpenGL3_Data* bd = ImGui_ImplOpenGL3_GetBackendData();
	...
	bool ImGuiOpenGLHandler::CheckProgram(GLuint handle, const char* desc)
	{
		ImGui_ImplOpenGL3_Data* bd = ImGui_ImplOpenGL3_GetBackendData();
		GLint status = 0, log_length = 0;
	...
	bool ImGuiOpenGLHandler::ImGui_ImplOpenGL3_CreateDeviceObjects()
	{
		ImGui_ImplOpenGL3_Data* bd = ImGui_ImplOpenGL3_GetBackendData();
	...
	void  ImGuiOpenGLHandler::ImGui_ImplOpenGL3_DestroyDeviceObjects()
	{
		ImGui_ImplOpenGL3_Data* bd = ImGui_ImplOpenGL3_GetBackendData();
